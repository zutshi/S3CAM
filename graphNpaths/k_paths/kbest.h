...
template <> Node<GraphHeap *> *Node<GraphHeap *>::freeList = NULL;//adi
template <> const int Node<GraphHeap *>::newBlocksize = 64;//adi

template <> Node<GraphArc *> *Node<GraphArc *>::freeList = NULL;//adi
template <> const int Node<GraphArc *>::newBlocksize = 64;//adi

template <> Node<List<GraphArc *> > *Node<List<GraphArc *> >::freeList = NULL;//adi
template <> const int Node<List<GraphArc *> >::newBlocksize = 64;//adi
